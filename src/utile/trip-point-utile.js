...
const isStartDateExpired = (startDate) => startDate && dayjs().isAfter(startDate, 'D MMMM');


export {humanizeDate, humanizeHour, humanizeStartDate, differenceHoursMinutes, isStartDateExpired};
